...
/**
* Slimeball class inheriting from Moveable as a projectile
*/
public class Slimeball extends Moveable implements Projectile
{
    ...
    public Object collideObjects(Object[][] objects)
    {
        ...
        if (objects[newY][newX] != null && !(objects[newY][newX] instanceof Slimeball))
        {
